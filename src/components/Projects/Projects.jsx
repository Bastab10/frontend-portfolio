...
function Projects() {
  ...
  const totalScroll = Math.max(
    slider.scrollWidth - section.clientWidth + 60,
    0
  );
  ...
  return (
    <section
      ...
      className="relative min-h-screen overflow-hidden bg-[#F7F7F5] px-4 sm:px-6 md:px-8 lg:px-16 py-20 md:py-24 lg:py-32"
    >
      ...
      <div className="relative lg:hidden max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-sm leading-7 text-neutral-500">
            ...
            architecture, modern UI and performance.
          </p>
        </motion.div>
      ...
      <div
        ref={sliderRef}
        className="hidden lg:flex w-max items-center gap-8 xl:gap-10 pl-8 md:pl-16 lg:pl-18"
      >
        <div className="w-[380px] xl:w-[450px] shrink-0">
          ...
          <h2
            id="projects-heading-desktop"
            className="text-6xl xl:text-7xl font-light leading-[0.9]"
          >
            Featured Projects
          </h2>
